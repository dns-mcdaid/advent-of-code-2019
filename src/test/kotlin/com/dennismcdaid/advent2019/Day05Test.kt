...
class Day05Test {
  ...
  val input = Parser.readLongs("day05_input.txt")
  ...
  inner class Part2 {
    ...
    fun `Basic examples pass`() {
      val example0 = longArrayOf(3, 9, 8, 9, 10, 9, 4, 9, 99, -1, 8)
      assertThat(Day05.execute(example0, 8)).isEqualTo(1)
      val example1 = longArrayOf(3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8)
      assertThat(Day05.execute(example1, 8)).isEqualTo(0)
      val example2 = longArrayOf(3, 3, 1108, -1, 8, 3, 4, 3, 99)
      assertThat(Day05.execute(example2, 8)).isEqualTo(1)
      val example3 = longArrayOf(3, 3, 1107, -1, 8, 3, 4, 3, 99)
      assertThat(Day05.execute(example3, 8)).isEqualTo(0)
      val example4 = longArrayOf(3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9)
      assertThat(Day05.execute(example4.copyOf(), 0)).isEqualTo(0)
      assertThat(Day05.execute(example4.copyOf(), 1)).isEqualTo(1)
      val example5 = longArrayOf(3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1)
